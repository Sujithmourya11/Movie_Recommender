...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/Sujithmourya11/Movie_Recommender/blob/master/requirements.txt) file with the command `pip install -r requirements.txt`.
